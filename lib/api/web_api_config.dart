class WebApiConfig {
  ...
  static const String defaultFlatRestaurantsUrl =
  ...
  static const String flatRestaurantsUrl = String.fromEnvironment(
    "SELFX_WEB_FLAT_RESTAURANTS_URL",
    defaultValue: defaultFlatRestaurantsUrl,
  );
}
